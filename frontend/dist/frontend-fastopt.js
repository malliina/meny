...
const $s_Lcom_malliina_meny_frontend_Frontend__main__AT__V = (function(args) {
  const this$3 = $m_s_Console$();
  const this$4 = this$3.out__Ljava_io_PrintStream();
  this$4.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Front!\n")
});
...
$L0 = new $c_RTLong(0, 0);
$s_Lcom_malliina_meny_frontend_Frontend__main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
